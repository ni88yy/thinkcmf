...
<link href="__ROOT__/statics/simpleboot/font-awesome/4.1.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="__ROOT__/statics/simpleboot/font-awesome/4.1.0/css/font-awesome-ie7.min.css<?php echo ($js_debug); ?>">
<![endif]-->
<link rel="stylesheet" href="__ROOT__/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?<?php echo ($js_debug); ?>">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="__ROOT__/statics/simpleboot/css/simplebootadminindex-ie.css?<?php echo ($js_debug); ?>" />
<![endif]-->
					...
					<li>
						<?php if(empty($menu->items)){ ?>
							<a href="javascript:openapp('<?php echo ($menu->url); ?>','<?php echo ($menu->id); ?>','<?php echo ($menu->name); ?>');">
								<i class="fa fa-<?php echo (($menu->icon)?($menu->icon):'desktop'); ?>"></i>
								<span class="menu-text"><?php echo ($menu->name); ?></span>
							</a>
						<?php }else{ ?>
							<a href="#" class="dropdown-toggle">
								<i class="fa fa-<?php echo (($menu->icon)?($menu->icon):'desktop'); ?> normal"></i>
...
<body style="min-width:900px;" screen_capture_injected="true">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="__ROOT__/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
							<span class="user-info">
								<small>欢迎,</small><?php echo (($admin["user_nicename"])?($admin["user_nicename"]):$admin[user_login]); ?>
							</span>
	...
	<script src="__ROOT__/statics/simpleboot/js/jquery.js"></script>
	...
	<script src="__TMPL__assets/js/index.js?<?php echo ($js_debug); ?>"></script>
