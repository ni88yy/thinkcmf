...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     ...
     <li class="active"><a href="<?php echo U('Page/add');?>">添加页面</a></li>
  </ul>
  <form name="myform" id="myform"  action="<?php echo U('page/add_post');?>" method="post" class="form-horizontal J_ajaxForms" enctype="multipart/form-data">
