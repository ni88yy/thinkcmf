  ...
  <form class="well form-search" method="post" action="<?php echo u('post/index');?>">
    <div class="search_type cc mb10">
      <div class="mb10"> 
        ...
        &nbsp;&nbsp;时间：
        <input type="text" name="start_time" class="input length_2 J_date" value="<?php echo (($formget["start_time"])?($formget["start_time"]):''); ?>" style="width:80px;" autocomplete="off">-<input type="text" class="input length_2 J_date" name="end_time" value="<?php echo ($formget["end_time"]); ?>" style="width:80px;" autocomplete="off">
