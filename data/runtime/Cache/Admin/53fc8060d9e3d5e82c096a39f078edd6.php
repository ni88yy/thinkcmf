...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     ...
     <li class="active"><a href="#"><?php echo (($term["name"])?($term["name"]):'页面编辑'); ?></a></li>
  </ul>
  ...
  <div class="col-right">
    <div class="table_full">
      <table width="100%">
        ...
        <tr>
          <td>
          	<div  style="text-align: center;"><input type='hidden' name='smeta[thumb]' id='thumb' value="<?php echo (($smeta["thumb"])?($smeta["thumb"]):''); ?>">
			<a href='javascript:void(0);' onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
			
			<?php if(empty($smeta['thumb'])): ?><img src="__ROOT__/statics/images/icon/upload-pic.png" id='thumb_preview' width='135' height='113' style='cursor:hand' />
			<?php else: ?>
      ...
      <table width="100%"  cellpadding="2" cellspacing="2">
            ...
            <tr>
              ...
              <td><span class="must_red">*</span><div id='content_tip'></div>
                ...
                <script type="text/javascript"  src="__ROOT__/statics/js/ueditor/ueditor.config.js<?php echo ($js_debug); ?>"></script>
                <script type="text/javascript"  src="__ROOT__/statics/js/ueditor/ueditor.all.min.js<?php echo ($js_debug); ?>"></script>
				<script type="text/javascript">
    			var editorcontent;
              ...
              <td>
		        ...
		        <ul id="photos" class="picList">
			        <?php if(is_array($smeta['photo'])): foreach($smeta['photo'] as $key=>$vo): ?><li id="savedimage<?php echo ($key); ?>">
				        	<input type="text" name="photos_url[]" value="__UPLOAD__<?php echo ($vo['url']); ?>" title='双击查看' style="width:310px;" ondblclick="image_priview(this.value);" class="input">
